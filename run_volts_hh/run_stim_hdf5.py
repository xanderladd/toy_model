...
params_file_path = './params/params_hh_full.hdf5'
...
#i=int(sys.argv[1])
#i = 1
curr_stim_name_list = stims_name_list[43:]#stims_name_list[(i-1)*num_stims_to_run:(i)*num_stims_to_run]
